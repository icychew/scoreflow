...
GUITAR_CONFIG = TranscriptionConfig(
    ...
    frame_threshold=0.3,
    minimum_note_length=80.0,  # 100ms dropped staccato/muted notes (which sustain
                               # ~80-110ms); 80ms aligns with bass/other. The 50ms
                               # postprocess floor still removes real artifacts.
